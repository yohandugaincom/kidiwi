...
<img src="/public/img/origami.png" width="100px" style="vertical-align: -15px;" /> Kid'iwi</span></br>
   <span id="status" class="animated fadeIn">Version de démonstration</span></p>
   <p style="font-size:18px;">2 utilisateurs pro, 5 messages et 1 évènement vont être générés.</br>Inscrivez-vous avec l'email <b>demo@kidiwi.fr</b> pour accédez à ces messages.</p>
   <div id="fin" align="center" class="animated fadeIn" style="margin-top:1%;display:block;">
     <a href="/dev/generer_demo.php"><button class="btn btn-light btn-lg animated pulse infinite">Activer</button></a>
   </div>
</div>
</div>
