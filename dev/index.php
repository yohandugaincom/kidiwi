...
<img src="/public/img/origami.png" width="100px" style="vertical-align: -15px;" /> Kid'iwi</span></br>
   ...
   <p style="font-size:18px;" class="animated fadeIn"><?php if (file_exists($_SERVER['DOCUMENT_ROOT']."/dev/active.kidiwi")) {echo "État du site : Actif";} else {echo "État du site : Inactif";} ?></p>
   <div id="fin" align="center" class="animated fadeIn" style="margin-top:1%;">
     ...
     <?php if (file_exists($_SERVER['DOCUMENT_ROOT']."/dev/active.kidiwi")) {echo '<a href="/dev/reinitialiser.php"><button class="btn btn-danger btn-lg">Réinitialiser</button></a>';} ?>
     <?php if (file_exists($_SERVER['DOCUMENT_ROOT']."/dev/active.kidiwi")) {echo '<a href="/dev/demo.php"><button class="btn btn-secondary btn-lg">Version démo</button></a>';} ?>
