...
<script>
  ...
  setTimeout(status, 700, "Copie de données en cours...");
  setTimeout(status, 1000, "Vérification des données...");
  setTimeout(status, 1200, "La version de démonstration est activée.");
  setTimeout(fin, 1500);
</script>
