...
<html>
  <head>
    ...
    <title>[MAINTENANCE] Kid'iwi</title>
...
body {
	...
	height: 90vh;
	color: #fff;
	background: linear-gradient(-45deg, #2ecc71, black, #d35400);
...
<img src="/public/img/origami.png" width="100px" style="vertical-align: -15px;" /> Kid'iwi</span></br>
   <span id="status" class="animated fadeIn slower">Maintenance en cours...</span></p>
   <p style="font-size:18px;" class="animated fadeIn">Au nom de toute l'équipe, nous nous excusons pour la gêne occasionnée.</p>
