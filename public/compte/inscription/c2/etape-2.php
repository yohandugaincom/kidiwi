...
function direct() {
  ...
  req.open('GET', '/public/compte/inscription/c2/verifier_email.php?email=<?php
...
if (isset($_GET['activation'])) {
  ...
  req.open('GET', '/public/compte/inscription/c2/verifier_email.php?email=".$_GET['email']."&code=".$_GET['activation']."', false);
  req.send(null);
  if (req.status === 200) {
      if (req.responseText=='true') {
        document.getElementById('good').style.display = 'block';
