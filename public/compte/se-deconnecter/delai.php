...
<img src="/public/img/origami.png" width="100px" style="vertical-align: -15px;" />
   Kid'iwi</span></br>
<span class="animated fadeIn delay-1s">Vous avez été déconnecté pour cause d'inactivité.</span></p>
  <span class="animated fadeIn delay-2s">
	<a href="/public/compte/se-connecter.php"><button class="btn btn-light btn-lg animated pulse infinite" id="continue">Se connecter</button></a>
	</span>
</div>
