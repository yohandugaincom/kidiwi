...
<img src="/public/img/origami.png" width="100px" style="vertical-align: -15px;" />
   Kid'iwi</span></br>
<span class="animated fadeIn delay-1s">Désolé, cette page n'existe pas.</span></p>
  <span class="animated fadeIn delay-2s">
	<a href="/public/accueil"><button class="btn btn-light btn-lg animated pulse infinite" id="continue">Retourner à l'accueil</button></a>
	</span>
</div>
